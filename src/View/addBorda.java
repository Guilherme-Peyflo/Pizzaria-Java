 ...
 * @author guilh
 */
public class addBorda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nome Borda:");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        jLabel2.setText("Preço:");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 30)); // NOI18N
        jLabel4.setText("Adicionando Borda");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String borda = txnome.getText();
        String preco = txpreco.getText();
     
        
        if(borda.isEmpty()||preco.isEmpty()){
            JOptionPane.showMessageDialog(rootPane, "Preencha todos os campos!!");
        }else{
            DaoBorda add = new DaoBorda();
            add.add(borda,preco);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addBorda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
